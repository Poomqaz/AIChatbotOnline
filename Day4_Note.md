...
{/* Header */}
      <div className="bg-white shadow-sm p-4 border-b">
        <h1 className="text-xl font-semibold text-gray-800 text-center">2AI Chatbot</h1>
        ...
        <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
          <div className="text-center">
            <div className="flex items-center justify-center space-x-2 mb-4">
              ...
              <span className="text-lg font-bold text-slate-900 dark:text-white">2AI Chatbot</span>
            </div>
            <p className="text-slate-600 dark:text-slate-300">
              © 2025 2AI Chatbot. สร้างด้วย ❤️ และ AI
            </p>
          </div>
        </div>
      </footer>
        ...
        <div className="relative z-10 flex flex-col justify-center px-12 text-white">
          <div className="max-w-md">
            <div className="flex items-center space-x-2 mb-8">
              ...
              <span className="text-2xl font-bold">2AI</span>
            </div>
