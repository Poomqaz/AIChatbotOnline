    ...
    <div className="space-y-6">
      ...
      <div>
        ...
        <div className="space-y-4">
          ...
          <p className="text-sm text-gray-600 dark:text-gray-400">
            Let 2AI save and use memories when responding.
          </p>
          ...
          <p className="text-sm text-gray-600 dark:text-gray-400">
            Let 2AI reference all previous conversations when responding.
          </p>
          ...
          <p className="text-sm text-gray-600 dark:text-gray-400">
            2AI may use Memory to personalize queries to search providers, such as Bing.{" "}
      ...
      <div>
        ...
        <div className="space-y-4">
          ...
          <p className="text-sm text-gray-600 dark:text-gray-400">
            Let 2AI reference all previous recording transcripts and notes when responding.
          </p>
        </div>
      </div>
    </div>
