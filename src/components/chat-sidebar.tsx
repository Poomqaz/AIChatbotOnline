...
import {
  ...
  SidebarMenuButton,
  useSidebar,
} from "@/src/components/ui/sidebar"                                             // Sidebar components และ hooks
import {
  Popover,
  PopoverContent,
  PopoverTrigger,
} from "@/src/components/ui/popover"                                             // Popover สำหรับ user menu
import {
  AlertDialog,
  AlertDialogAction,
  AlertDialogCancel,
  ...
  AlertDialogHeader,
  AlertDialogTitle,
} from "@/src/components/ui/alert-dialog"                                        // Alert dialog สำหรับยืนยันการลบ
import { 
  PlusIcon, 
  Search, 
  Settings, 
...
import { LogoutButton } from "@/src/components/logout-button"                   // Component สำหรับ logout
...
import { useChatContext } from "@/src/context/chat-context"                     // Context สำหรับ chat state
import { useChatSessions } from "@/src/hooks/use-chat-sessions"                  // Custom hook สำหรับ chat sessions
import { groupSessionsByDate } from "@/src/lib/utils"                            // Utility สำหรับจัดกลุ่มตามวันที่
import {
  GeneralTab,
  NotificationsTab,
  PersonalizationTab,
  ...
  SecurityTab,
  AccountTab
} from "@/src/components/settings"                                               // Settings tab components
import { ThemeToggle } from "@/src/components/ui/theme-toggle"                   // Theme toggle component
...
function SettingsDialog({ isOpen, onClose }: { isOpen: boolean; onClose: () => void }) {
  ...
  const mounted = true                                                          // สถานะการ mount ของ component - เริ่มต้นเป็น true สำหรับ client-side
