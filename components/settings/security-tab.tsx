...
export function SecurityTab() {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Secure sign in with 2AI */}
      <div>
        <Label className="text-lg font-medium text-gray-900 dark:text-white mb-2 block">
          Secure sign in with 2AI
        </Label>
        <p className="text-sm text-gray-600 dark:text-gray-400 mb-4">
          Sign in to websites and apps across the internet with the trusted security of 2AI.{" "}
        ...
        <div className="bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg p-4">
          <p className="text-sm text-gray-600 dark:text-gray-400 text-center">
            You haven&apos;t used 2AI to sign into any websites or apps yet. Once you do, they&apos;ll show up here.
          </p>
        </div>
      </div>
    </div>
